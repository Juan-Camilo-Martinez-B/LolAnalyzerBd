-- =============================================================================
-- Migration: V3__add_views_and_triggers.sql
-- Description: Adds audit triggers, helper stored functions, and analytical views
-- for LolAnalyzer metrics, champion performance, and AI coach impact.
